...
public class Hash03WordCloud {

    private Map<String, Integer> wordsToCounts = new HashMap<>();

    public Hash03WordCloud(String inputString) {
    ...
    public static void main(String[] args) {
        String str1 = "After beating the eggs, Dana read the next step: the-boy.";
        String str2 = "Add milk and eggs, then add flour and sugar. Then add the milk-yougurt for three times.";
        String str3 = "We came, we saw, we conquered...then we ate Bill's (Mille-Feuille) cake.";

        Map<String, Integer> cloud = new Hash03WordCloud(str3).getWordsToCounts();

        for (String word : cloud.keySet()) {
            System.out.println("Key: " + word + " - " + "Times: " + cloud.get(word));
        }
    }
}
